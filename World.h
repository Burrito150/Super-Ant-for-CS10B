...
const int INITIAL_ANTS = 5; // was 5

// Number of initial bugs
const int INITIAL_BUGS = 5; // was 5 and const

//Number of initial SuperAnts
const int INITIAL_SUPERANTS = 2; // was 3

// Time steps between breeding of ants
const int BREED_ANTS = 1;

// Time steps between breeding of bugs
const int BREED_BUGS = 5;

// Time between SUperAnts breeding
const int BREED_SUPERANT = 5;

// Time steps until bugs die if they have not eaten
const int STARVE_BUGS = 10;

const int STARVE_SUPERANT = 10;
